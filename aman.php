...
<body style="background-color: #231E23";>
    <div class="body-container">
        <div class="top-flex" style="background:#91091E; border: 5px solid #EEEBDD;border-radius:40px;">
            ...
            <a  style="position:absolute; padding:3px; right:3%; top:30px; color: #EEEBDD; background-color:#810000;border:2px solid #EEEBDD; border-radius:10px; " class="header-link "href="index.php?logout='1'"><b>Sign out</b> </a>
        </div>
        <br>
