...
<body>
    <div class="body-container">
        <div class="top-flex">
            <a class="header-link "href="logout.php"><b>sign out</b> </a>
        ...
        <form>
            <p class="top-search">Press the Submit button to get latest movies according to your choices</p>
            <p class="top-search">If you have any specific interest, type it in the search box.</p>
            <div class="form-group">
                <input type="text" id="inputValue">
                <button type="submit" id="search">Submit </button>
                <button id=button>Reset Values</button>
            </div>
        </form>
